...
@section('title', 'Admin - Novo Professor')

@section('content')
    <div class="d-flex align-items-center justify-content-between mb-3">
        <div>
            <h4 class="fw-bold mb-0">Cadastrar Professor</h4>
            <div class="text-muted">Adicionar novo professor ao sistema</div>
        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="professor_type"
                            ...
                            <option value="efetivo" {{ old('professor_type') === 'efetivo' ? 'selected' : '' }}>Efetivo</option>
                            <option value="contratado" {{ old('professor_type') === 'contratado' ? 'selected' : '' }}>Contratado</option>
                        </select>
